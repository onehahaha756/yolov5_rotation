...
import test_rotation_clss  as test# import test.py to get mAP after each epoch
from models.experimental import attempt_load
from models.yolo_rotation_clss import Model
...
from utils.loss_rotation_cls import ComputeLoss_cls 
...
def train(hyp, opt, device, tb_writer=None):
    ...
    #freeze += ['model.%s.' % x for x in range(13,29)]
    # Freeze
    ...
    if hyp['iou_smooth_l1']:
        ...
        compute_loss = ComputeLoss_cls(model)  # init loss class
...
if __name__ == '__main__':
    ...
    parser.add_argument('--img-size', nargs='+', type=int, default=[640, 1024], help='[train, test] image sizes')
