...
def nmsbynamedict(nameboxdict, nms, thresh):
    ...
    for imgname in tqdm(nameboxdict):
...
if __name__ == '__main__':
    ...
    srcpath='/data/02_code_implement/yolov5_rotation/yolov5_rotation/runs/detect/dotav2/yolov5s-dotav2-skewiou-loss-1024-600/exp16/patch_results'
    dstpath='/data/02_code_implement/yolov5_rotation/yolov5_rotation/runs/detect/dotav2/yolov5s-dotav2-skewiou-loss-1024-600/exp16/submit'
