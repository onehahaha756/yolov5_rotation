...
def main():
    detpath = r'/data/02_code_implement/yolov5_rotation/yolov5_rotation/runs/dotav2/exp57/submit/Task2_{:s}.txt'
    ...
    classnames = ['plane', 'baseball-diamond', 'bridge', 'ground-track-field', 'small-vehicle', 'large-vehicle', 'ship', 'tennis-court',
                'basketball-court', 'storage-tank',  'soccer-ball-field', 'roundabout', 'harbor', 'swimming-pool', 'helicopter', 'container-crane','container-crane','airport','helipad']
    # For DOTA v1.0
    # classnames = ['plane', 'baseball-diamond', 'bridge', 'ground-track-field', 'small-vehicle', 'large-vehicle', 'ship', 'tennis-court',
